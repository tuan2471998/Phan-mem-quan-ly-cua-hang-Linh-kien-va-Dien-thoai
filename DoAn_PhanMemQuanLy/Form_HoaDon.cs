    ...
    public partial class Form_HoaDon : Form
    {
        ...
        private void bt_TimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                if (bt_TimKiem.Text == "Tìm Kiếm")
                {
                    ...
                    string Timkiem = "SELECT * FROM HOADON WHERE MaKH = @MaKH"; ;
                    SqlCommand comd = new SqlCommand(Timkiem, conn);

                    comd.Parameters.AddWithValue("MaHD",txt_MaHD.Text);
                    comd.Parameters.AddWithValue("NgayBan", dtp_NgayBan.Text);
                    comd.Parameters.AddWithValue("MaKH", txt_TimKiem.Text);
            ...
            catch { MessageBox.Show("Tìm kiếm dữ liệu thất bại (-_-)"); }
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                dtp_NgayBan.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                txt_MaKH.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                txt_TenKH.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
                txt_MaSP.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
                txt_TenSP.Text = dataGridView1.CurrentRow.Cells[5].Value.ToString();
                txt_SoLuong.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                txt_DonGia.Text = dataGridView1.CurrentRow.Cells[7].Value.ToString();
                txt_ThanhTien.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
                txt_GiamGia.Text = dataGridView1.CurrentRow.Cells[9].Value.ToString();
                txt_TongTien.Text = dataGridView1.CurrentRow.Cells[10].Value.ToString();
            }
            catch
